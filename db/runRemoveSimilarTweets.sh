...
/space/hadoop/lib/python/bin/python3 removeSimilarTweets.py \
        --mode "local" \
        --filename "/space/tmp/matching-tweets_diab_noRT-noDupl.parquet" \
        --wordembeddingsPath "/space/tmp/FastText_embedding_20190701/ft_wordembeddings_dim300_minCount1_URL-User-toConstant_iter50_20190701" \
        --groupByName "user_name" \
	--saveResultPath "/space/tmp/matching-tweets_diab_noRT-noBots.parquet"

...
/space/hadoop/lib/python/bin/python3 train_jokes_classifier.py \
  --mode "local" \
  ...
  --modelAlgo "SVC" \
  --parameterGrid '{"model__C":[1.0, 0.1, 0.01], "model__tol":[1e-0, 1e-1], "model__kernel":["linear", "rbf", "poly"], "smote__k_neighbors":[5,6], "union__transformer_weights": [{"tweet":1, "userDesc":0.0}, {"tweet":1, "userDesc":0.1}]}' \

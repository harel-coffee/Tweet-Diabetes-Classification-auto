...
#                #    'model__hidden_layer_sizes' : [(64), (32), (16), (32, 16), (32, 16,16)],
#            #        'model__activation' : ['relu'], # ['relu', 'tanh', 'logistic'],
#        #            'model__solver' : ["adam"], #['adam', 'sgd'],
#    #                'model__learning_rate' : ['invscaling'], #['constant', 'invscaling'],
#                    'model__tol' : [1e-2, 1e-3],
...
#    print("\nBest: %f using %s" % (grid.best_score_, grid.best_params_))
    ...
    file_name = "best_model_tweets_classif_{}.sav".format(datetime.datetime.now().strftime(DATE_FORMAT))
